...
class ReadyToShipService {
    function updateAllReadyToShipFlags():void {
    ...
    function getQuantityAvailable(Product $product) {
        $quantityAvailable = 0;
    ...
    function getProductAvailabilityMap():array {
    ...
    function updateProductAvailabilityMap(array $productAvailabilityMap, Order $order): array {
        $readyToShip = true;
